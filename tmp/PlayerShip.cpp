...
/*   Updated: 2015/01/10 15:28:41 by mcassagn         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
PlayerShip::PlayerShip( void ) : ASpaceShip(100,  60, 50, 10, 10) {
	this->_live = 3;
}

PlayerShip::PlayerShip( int hp, int armor, int damage, int X, int Y ) : ASpaceShip(hp,  armor, damage, X, Y) {
	this->_live = 3;
}
